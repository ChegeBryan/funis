        ...
        <div class="col-md-10 col-md-11 display-table-cell valign-top box ">
          <div class="row">
            <header id="nav-header" class="clearfix">
              <div class="col-md-5">
                ...
                <input type="text" id="header-search-field" name="" class="hidden-sm hidden-xs"
              ...
              <div class="col-md-7">
                <ul class="pull-right">
                  ...
                  <li>
                    <a href="" class="logout"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span> Log
                      out</a>
                  </li>
                </ul>
              </div>
          ...
          <div id="content">
            <header class="clearfix">
              <h2 class="page_title">Order List</h2>
              <a href="reports/orders.php" class="btn btn-primary pull-right" target="_blank" download>Generate
                Report</a>
